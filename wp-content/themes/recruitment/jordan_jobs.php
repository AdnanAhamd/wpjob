...
if (isset($_GET['page-name'])) {
    ...
    if ($page_slug === 'latest-job-in-jordan') {
        $region_slug = 'jordan';
    } elseif ($page_slug === 'latest-jobs-in-gulf') {
        $region_slug = 'gulf';
    }
}
else{
	if ($current_slug === 'latest-job-in-jordan') {
        $region_slug = 'jordan';
    } elseif ($current_slug === 'latest-jobs-in-gulf') {
        $region_slug = 'gulf';
    }
}
